...
('host_confirmed','90000000-0000-0000-0000-000000000001','host.confirmed@picklematch.vn','+84901111111','Minh Tú','H? Chí Minh','level_4','intermediate',1300,1315,true,false,5,18,0,98,28,array['Friendly','On-time','Great Host']),
('host_approval','90000000-0000-0000-0000-000000000002','host.approval@picklematch.vn','+84902222222','Thu Trang','H? Chí Minh','level_3','intermediate',1150,1165,false,false,5,12,1,92,15,array['Friendly']),
('matched_player','90000000-0000-0000-0000-000000000003','player.matched@picklematch.vn','+84903333333','Kevin','H? Chí Minh','level_4','intermediate',1300,1285,false,false,5,10,0,96,0,array['Fair Play']),
('lower_skill','90000000-0000-0000-0000-000000000004','player.lower@picklematch.vn','+84904444444','B?o Ng?c','H? Chí Minh','level_2','basic',1000,1020,false,false,5,7,1,88,0,array[]::text[]),
('provisional_host','90000000-0000-0000-0000-000000000006','host.provisional@picklematch.vn','+84906666666','Phuong Linh','H? Chí Minh','level_2','basic',1000,1000,false,true,2,4,0,100,4,array[]::text[]),
('social_player','90000000-0000-0000-0000-000000000007','player.social@picklematch.vn','+84907777777','Hoàng Nam','H? Chí Minh','level_3','intermediate',1150,1175,false,false,5,9,0,95,0,array['Friendly']);
...
('90000000-0000-0000-0000-000000000001','active_member_20','H?i viên tích c?c','progression','Hoàn thành 20 tr?n pickleball trên PickleMatch.','medal',now()-interval '10 day','{"source":"sql-seed"}'),
('90000000-0000-0000-0000-000000000001','golden_host','Host Vàng','conduct','Gi? di?m host trung bình t? 4.9 tr? lên.','shield',now()-interval '4 day','{"source":"sql-seed"}'),
('90000000-0000-0000-0000-000000000003','giant_slayer','Giant Slayer','performance','Th?ng m?t kèo có ngu?ng trình cao hon b?n ít nh?t 100 Elo.','swords',now()-interval '6 day','{"source":"sql-seed"}'),
('90000000-0000-0000-0000-000000000003','win_streak_3','Win Streak','momentum','Ð?t chu?i th?ng 3 tr?n liên ti?p.','flame',now()-interval '2 day','{"source":"sql-seed"}');
...
('11111111-1111-1111-1111-111111111111','Sân Pickleball Tân Bình','Tan Binh Pickleball','123 Hoàng Van Th?','H? Chí Minh','Tân Bình',10.801,106.658,240000,4,4.7,48,'0901111111','06:00','22:00','M? c? tu?n','indoor','hard',180000,260000,'Gi? cao di?m cu?i tu?n tang giá','Sân sáng, có ch? g?i xe',array['indoor','central','busy'],'https://maps.google.com/?q=123+Hoang+Van+Thu','https://example.com/booking/tan-binh',now()),
('22222222-2222-2222-2222-222222222222','Sân Pickleball V?n Phúc','Van Phuc Pickleball','Khu dô th? V?n Phúc','H? Chí Minh','Th? Ð?c',10.845,106.706,200000,6,4.5,31,'0902222222','06:00','23:00','Có khu cafe','outdoor','hard',150000,220000,'Giá ?n d?nh','Nhi?u sân, d? ghép d?i',array['outdoor','social'],'https://maps.google.com/?q=Van+Phuc+City','https://example.com/booking/van-phuc',now()),
('33333333-3333-3333-3333-333333333333','Sân Pickleball Th?o Ði?n','Thao Dien Pickleball','88 Xuân Th?y','H? Chí Minh','Th?o Ði?n',10.806,106.736,280000,2,4.9,19,'0903333333','07:00','22:00','Sân d?p, ít slot','indoor','acrylic',250000,320000,'Premium court','Phù h?p kèo trình cao',array['premium','indoor'],'https://maps.google.com/?q=88+Xuan+Thuy','https://example.com/booking/thao-dien',now());
...
('55555555-5555-5555-5555-555555555551','90000000-0000-0000-0000-000000000001','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555551','90000000-0000-0000-0000-000000000003','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555552','90000000-0000-0000-0000-000000000002','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555552','90000000-0000-0000-0000-000000000007','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555557','90000000-0000-0000-0000-000000000001','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555557','90000000-0000-0000-0000-000000000003','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555557','90000000-0000-0000-0000-000000000004','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555558','90000000-0000-0000-0000-000000000002','confirmed','win','pending','confirmed',now()-interval '1 day'+interval '23 hour',null,null,null,null,null),
('55555555-5555-5555-5555-555555555558','90000000-0000-0000-0000-000000000003','confirmed','loss','pending','awaiting_player',null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555558','90000000-0000-0000-0000-000000000007','confirmed','loss','pending','confirmed',now()-interval '1 day'+interval '23 hour 20 minute',null,null,null,null,null),
('55555555-5555-5555-5555-555555555559','90000000-0000-0000-0000-000000000001','confirmed','win','pending','confirmed',now()-interval '2 day'+interval '21 hour',null,null,null,null,null),
('55555555-5555-5555-5555-555555555559','90000000-0000-0000-0000-000000000003','confirmed','loss','pending','confirmed',now()-interval '2 day'+interval '21 hour 15 minute',null,null,null,null,null),
('55555555-5555-5555-5555-555555555559','90000000-0000-0000-0000-000000000007','confirmed','loss','pending','disputed',null,now()-interval '2 day'+interval '22 hour','T? s? host submit không dúng v?i k?t qu? th?c t?.',null,null,null),
('55555555-5555-5555-5555-555555555562','90000000-0000-0000-0000-000000000001','confirmed',null,'pending',null,null,null,null,null,null,null),
('55555555-5555-5555-5555-555555555562','90000000-0000-0000-0000-000000000003','confirmed',null,'pending',null,null,null,null,'not_played',now()-interval '4 day'+interval '20 hour 45 minute','Host không có m?t, tr?n không di?n ra.'),
('55555555-5555-5555-5555-555555555562','90000000-0000-0000-0000-000000000004','confirmed',null,'pending',null,null,null,null,'not_played',now()-interval '4 day'+interval '20 hour 50 minute','Ð?n sân nhung không th?y host.'),
('55555555-5555-5555-5555-555555555562','90000000-0000-0000-0000-000000000007','confirmed',null,'pending',null,null,null,null,'not_played',now()-interval '4 day'+interval '20 hour 55 minute','C? nhóm xác nh?n tr?n b? ghost.');

insert into public.join_requests (match_id,player_id,status,intro_note,host_response_template) values
('55555555-5555-5555-5555-555555555552','90000000-0000-0000-0000-000000000006','pending','Mình m?i qua placement nhung gi? bóng khá ?n.','Ð?i mình gom d? ngu?i r?i báo nhé.'),
('55555555-5555-5555-5555-555555555551','90000000-0000-0000-0000-000000000007','accepted','Mình vào giao luu nh? nhàng.',null)
...
('66666666-6666-6666-6666-666666666661','90000000-0000-0000-0000-000000000002','join_request','Có yêu c?u tham gia m?i','Có ngu?i mu?n vào kèo ch? duy?t c?a b?n.','/session/55555555-5555-5555-5555-555555555552',false,now()),
('66666666-6666-6666-6666-666666666670','90000000-0000-0000-0000-000000000003','session_results_submitted','Host dã g?i k?t qu?','Hãy vào xem và xác nh?n k?t qu? c?a tr?n v?a xong.','/session/55555555-5555-5555-5555-555555555558',false,now()-interval '1 day'),
('66666666-6666-6666-6666-666666666671','90000000-0000-0000-0000-000000000001','session_results_disputed','Có tranh ch?p k?t qu?','M?t ngu?i choi v?a báo sai k?t qu? tr?n d?u.','/session/55555555-5555-5555-5555-555555555559',false,now()-interval '2 day'),
('66666666-6666-6666-6666-666666666674','90000000-0000-0000-0000-000000000001','ghost_session_voided','Kèo b? dánh d?u không di?n ra','Ngu?i choi dã báo tr?n d?u không di?n ra và session b? void.','/session/55555555-5555-5555-5555-555555555562',false,now()-interval '4 day');
